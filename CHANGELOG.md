...
- **Areas are declared, renamed and retired over the API** — a project that declares no vocabulary yet gets one from its first declaration, and the work assigned beneath a renamed or retired area is reassigned or unassigned as the call directs.
