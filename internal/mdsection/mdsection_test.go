...
func TestSet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, appended := SetAtLevel(tt.body, tt.matchLevel, tt.appendLevel, tt.heading, tt.content)
			if got != tt.want {
				t.Errorf("SetAtLevel() =\n%q\nwant:\n%q", got, tt.want)
			}
			if appended != tt.wantAppended {
				t.Errorf("SetAtLevel() appended = %v, want %v", appended, tt.wantAppended)
			}
		})
	}
}
...
func TestSetWildcard(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, appended := Set(tt.body, tt.appendLevel, tt.heading, tt.content)
			if got != tt.want {
				t.Errorf("Set() =\n%q\nwant:\n%q", got, tt.want)
			}
			if appended != tt.wantAppended {
				t.Errorf("Set() appended = %v, want %v", appended, tt.wantAppended)
			}
		})
	}
}
