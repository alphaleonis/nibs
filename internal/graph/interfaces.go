...
type NibWriter interface {
	...
	// RemoveLinksTo strips every parent/blockedBy/milestone link that RESOLVES
	// to the target and returns how many it removed. Target and stored link ids are both
