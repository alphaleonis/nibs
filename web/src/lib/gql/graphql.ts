...
export type NibConflictSnapshotQuery = { nib: { id: string, title: string, status: string, type: string, priority: string, estimate: string, milestone: string, tags: Array<string>, body: string, etag: string } | null };
...
export type UpdateNibMutation = { updateNib: { id: string, title: string, status: string, type: string, priority: string, estimate: string, milestone: string, tags: Array<string>, etag: string } };
...
export type NibChangedSubscription = { nibChanged: { type: string, nibId: string, nib: { id: string, title: string, status: string, type: string, priority: string, estimate: string, milestone: string, tags: Array<string>, body: string, etag: string, updatedAt: string, parentId: string | null, blockingIds: Array<string>, blockedByIds: Array<string> } | null } };
