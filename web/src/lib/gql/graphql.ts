...
export type TreeTableQuery = { nibs: Array<{ id: string, title: string, status: string, type: string, priority: string, estimate: string, tags: Array<string>, createdAt: string, updatedAt: string, parentId: string | null, milestone: string, milestoneOrder: string, blockingIds: Array<string>, blockedByIds: Array<string>, etag: string }> };
