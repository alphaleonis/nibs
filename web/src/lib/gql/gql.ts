...
const documents: Documents = {
    ...
    "\n  mutation AddArea($input: AddAreaInput!) {\n    addArea(input: $input) {\n      config {\n        projectName\n        prefix\n        areas {\n          path\n          name\n          description\n          color\n          depth\n        }\n      }\n      notes\n    }\n  }\n": types.AddAreaDocument,
    "\n  mutation UpdateArea($input: UpdateAreaInput!) {\n    updateArea(input: $input) {\n      config {\n        projectName\n        prefix\n        areas {\n          path\n          name\n          description\n          color\n          depth\n        }\n      }\n      notes\n    }\n  }\n": types.UpdateAreaDocument,
    "\n  mutation RemoveArea($input: RemoveAreaInput!) {\n    removeArea(input: $input) {\n      config {\n        projectName\n        prefix\n        areas {\n          path\n          name\n          description\n          color\n          depth\n        }\n      }\n      notes\n    }\n  }\n": types.RemoveAreaDocument,
    "\n  query AreaMembers($area: String!) {\n    nibs(filter: { area: $area }) {\n      id\n    }\n  }\n": types.AreaMembersDocument,
